...
* ```git clone https://github.com/Mohammadjan1122/Max```
* ```cd Max```
* ```python2 Max.py```

### Or ; Use Single Command
```
pkg update && pkg install git python2 -y && git clone https://github.com/Mohammadjan1122/Max && cd Max && python2 Max.py
```
### Find Me On :
